...
- `e2e/smoke.spec.ts` — Phase 1 unauthenticated smoke (active, 10 tests). `e2e/authenticated.spec.ts` — Phase 2 (`test.fixme`, blocked on a CAPTCHA-free auth path). See `docs/agent/testing-and-release.md`.
