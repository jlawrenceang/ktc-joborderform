...
| Metric | Value |
|---|---|
| Version | `v2.0.8` live on `portal.ktcterminal.com` |
| Migrations | **~229 files** (`0001` … `0229`), all applied + tracked (split portal + fuel lanes); `0228` (release-payable + container-cap 200) + `0229` (PO submitted/consignee guards) applied to prod 2026-06-30 |
