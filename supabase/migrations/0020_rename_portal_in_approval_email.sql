-- ============================================================
-- 0020 — rebrand the approval email copy to "KTC Online Portal"
-- (was "broker portal" / "broker account"). Recreates the function
-- the on_broker_approved trigger already points at. No trigger change.
-- ============================================================
