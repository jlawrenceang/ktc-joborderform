...
export const cashierSteps: TourStep[] = [
  {
    icon: '💵', title: 'Welcome to the Cashier station',
  ...
  {
    icon: '🪟', title: 'Collect at the window',
  ...
  {
    icon: '🔢', title: 'Record the ERP invoice',
  ...
  {
    icon: '🚦', title: 'Two gates to complete',
...
export const supportSteps: TourStep[] = [
  {
    icon: '💬', title: 'Welcome to the Support inbox',
...
export const operationsSteps: TourStep[] = [
  ...
  {
    icon: '🏁', title: 'Complete the services',
