...
// The menu ("/") — the three ways in: Sign in / Create an account / Continue with Google.
// Google goes straight to OAuth; the email paths open the form (PublicShell swaps it into
// this same right column). Rendered into PublicShell's .ktc-landing__access section.
async function signInWithGoogle() {
  // New Google users come back with a verified email but no consent/contact — ProtectedRoute
  // routes them through FinishRegistration. (Needs the Google provider enabled in Supabase.)
